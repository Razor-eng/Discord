...
import { ChevronDownIcon, CogIcon, LogoutIcon, MicrophoneIcon, PhoneIcon, PlusIcon } from '@heroicons/react/outline';
    ...
    return (
        <>
            ...
            <div className='flex h-screen'>
                <div className='flex flex-col space-y-3 bg-discord_sidebar p-3 min-w-max'>
                ...
                <div className=' bg-discord_channelsBg flex flex-col min-w-max'>
                    ...
                    <div className=' text-discord_channel flex-grow overflow-y-scroll scrollbar-hide'>
                        <div className='flex items-center p-2 mb-2'>
                            ...
                            <PlusIcon className='h-6 ml-auto cursor-pointer hover:text-white' onClick={handleAdd} />
                        </div>
